...
fn inspect_artifacts_json_is_deterministic() -> Result<(), Box<dyn Error>> {
    ...
    assert_eq!(parsed["artifacts"].as_array().map(Vec::len), Some(22));
    assert_eq!(parsed["artifacts"][0]["path"], "Dockerfile");
    assert_eq!(parsed["artifacts"][0]["category"], "ContainerDefinition");
    assert_eq!(parsed["artifacts"][9]["path"], "docs/architecture.md");
    assert_eq!(parsed["artifacts"][21]["path"], "web/src/App.tsx");
    assert_eq!(parsed["artifacts"][21]["format"], "tsx");
...
web/src/App.tsx             SourceCode           tsx               DeepLanguage           300  e89fd652d40852d6b652916211423f4ff5bbd23b1f5100a62d0072c9735971c3  Text        Allowed        0    0
";
