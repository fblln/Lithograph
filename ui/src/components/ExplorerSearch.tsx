...
export function ExplorerSearch({ onFocus, onSelectTension = () => {}, onFocusCluster = () => {}, clusters = [], inputRef, scopeNodeIds = EMPTY_SCOPE, displayRootPrefix }: { onFocus: (id: string) => void; onSelectTension?: (tension: RepositoryTension) => void; onFocusCluster?: (cluster: ArchitectureCluster) => void; clusters?: ArchitectureCluster[]; inputRef?: RefObject<HTMLInputElement | null>; scopeNodeIds?: string[]; displayRootPrefix?: string }) {
